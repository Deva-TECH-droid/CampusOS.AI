...
export const deleteDeadline = (classroomId, deadlineId) =>
  api.delete(`classroom/${classroomId}/deadline/delete/${deadlineId}`);
...
export const adminUpdateClassroom = (id, payload) => api.put(`/classroom/admin/${id}`, payload);
export const adminDeleteClassroom = (id) => api.delete(`/classroom/admin/${id}`);
export const adminGetClassroomStudents = (id) => api.get(`/classroom/admin/${id}/students`);
export const adminAddPeriod = (classroomId, payload) =>
  api.post(`/classroom/admin/${classroomId}/periods`, payload);
export const adminUpdatePeriod = (classroomId, day, index, payload) =>
  api.put(`/classroom/admin/${classroomId}/periods/${day}/${index}`, payload);
