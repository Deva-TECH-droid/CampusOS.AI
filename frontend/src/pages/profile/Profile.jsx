  ...
  <div className="flex items-center gap-3 py-2.5 border-b border-gray-50 last:border-0">
    ...
    {isLink && url ? (
      <a
        ...
        className="text-xs font-medium text-blue-600 hover:underline truncate max-w-45 sm:max-w-none"
      >
        {value || "View Link"}
      </a>
    ) : (
      <span className="text-xs font-medium text-gray-800 truncate max-w-45 sm:max-w-none">
        {value || "—"}
      </span>
    )}
  </div>
              ...
              <>
                <div className="flex flex-wrap gap-2">
                  {visibleClubs.map((club, i) => (
                    ...
                    >
                      <div
                        className={`w-5 h-5 rounded flex items-center justify-center text-white text-xs font-bold shrink-0 ${clubBg[i % clubBg.length]}`}
                      >
                        {club.logo ? (
                          <img
                            src={club.logo}
                ...
                {recentApplications.map((app) => {
                  ...
                  return (
                    <Link
                      ...
                      className="flex items-center gap-3 p-3 bg-gray-50 border border-gray-100 rounded-xl hover:border-gray-300 transition-all group"
                    >
                      <div className="w-9 h-9 rounded-lg bg-white border border-gray-200 flex items-center justify-center shrink-0 overflow-hidden">
